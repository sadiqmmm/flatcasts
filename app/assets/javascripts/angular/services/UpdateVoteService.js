function UpdateVoteService($http, GetLectureService) {
...
UpdateVoteService.$inject = ['$http', 'GetLectureService']

angular.module('Flatcasts').service('UpdateVoteService', UpdateVoteService);
